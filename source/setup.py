...
if not (sys.version_info[0] == 3):
    sys.exit("OpenQASM currently supports Python 3.X only.")
...
DESCRIPTION = 'A quantum compilation framework'
...
PACKAGES = [
                'openqasm/parser',
                'openqasm/parser/antlr',
                'openqasm/ast_visitor',
		]
...
CLASSIFIERS = [
    ...
    'Topic :: Scientific/Engineering :: Compilation',
]
